...
contract Hurricash {
    ...
    uint256 constant ringMaxParticipants = 8; //expanded from 6 to 8 per ring
    ...
    uint256[10] allowedAmounts = [ 1 ether, 100 ether, 1000 ether, 100000 ether ];
    ...
    function deposit(uint256[2] memory publicKey) public payable
    {
        ...
        // otherwise we'll count 0.1 ETH as a donation to our relayer pool (gass for withdrawals)
        ...
        returns (uint256)
    {
        ...
        require(allowed, "Only select values allowed");
