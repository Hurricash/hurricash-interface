      ...
      <Form
        onSubmit={(e) => {
          (async () => {
            ...
            const { hcashswapInstance } = dappGateway;
            ...
            const maxParticipants: Number = await hcashswapInstance.methods
              .getRingMaxParticipants()
              .call();

            const blocksLeftForForceClose: Number =
              await hcashswapInstance.methods
              ...
              {modalParams.invalidToken ? (
                ...
                <div>
                  <Text>
                    ...
                    {modalParams.depositedParticipants >=
                      modalParams.maxParticipants ||
                    modalParams.ringHash.length === 66
                      ? "Closed"
                    ...
                    <br />
                    <strong>Ring participants: </strong>{" "}
